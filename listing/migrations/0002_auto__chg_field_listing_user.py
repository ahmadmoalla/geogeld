...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.user'
        db.alter_column('listing_listing', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Listing.user'
        db.alter_column('listing_listing', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile']))
